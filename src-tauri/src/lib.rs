...
use commands::{
    ...
    get_recent_sales, get_sales_history, cancel_sale, get_sale_details, refund_sale, get_pos_initial_state, open_cash_register, get_active_cash_session,
    add_cash_movement, close_cash_register, get_cash_movements, get_daily_sales_summary, get_monthly_revenue_report,
